...
- And now, it even **speaks the sentiment aloud** using Text-to-Speech 🎤🗣️
...
- 🗣️ Speaks result using Web Speech API
...
8. You’ll get a desktop **notification popup**
9. You'll hear a voice saying the sentiment aloud
...
- Make sure the system volume is up and Chrome is not muted
- Some OS versions may require restarting Chrome to enable speechSynthesis
- No external permissions needed – it uses built-in browser TTS
...
Dharsini Balakumaar
[https://github.com/DharsiniBalakumaar](https://github.com/DharsiniBalakumaar)
...
💖 Enjoy the voice-powered AI sentiment checker!
